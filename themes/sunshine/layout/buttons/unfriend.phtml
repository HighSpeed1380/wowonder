<span id="Follow-<?php echo $wo['follow']['user_id']?>" title="<?php echo $wo['lang']['unfriend'];?>">
    <button type="button" onclick="Wo_RegisterFollow(<?php echo $wo['follow']['user_id'];?>,0,true)" class="btn btn-active btn-default btn-sm wo_following_btn" id="wo_useract_btn">
       ...
       <span class="button-text"> <?php echo $wo['lang']['friends_btn'];?></span>
    </button>
</span>