<span id="Follow-<?php echo $wo['follow']['user_id']?>" title="<?php echo $wo['lang']['unfollow'];?>">
    <button type="button" onclick="Wo_RegisterFollow(<?php echo $wo['follow']['user_id'];?>)" class="btn-active btn btn-default btn-sm wo_following_btn" id="wo_useract_btn">
